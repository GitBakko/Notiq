...
export default function TaskListSharingModal({ isOpen, onClose, taskListId, sharedWith = [] }: TaskListSharingModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm" onClick={onClose}>
      <div className="w-full max-w-[calc(100vw-2rem)] sm:max-w-md rounded-xl bg-white p-6 shadow-xl dark:bg-neutral-900 dark:border dark:border-neutral-800" onClick={e => e.stopPropagation()}>
        <div className="mb-6 flex items-center justify-between">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-white">{t('sharing.titleTaskList')}</h2>
