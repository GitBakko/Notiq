...
export const changelog: VersionEntry[] = [
  ...
  },
  {
    ...
    date: '2026-08-24',
    entries: [
      { type: 'fix', titleKey: 'whatsNew.entries.kanbanTransformLimits' },
      { type: 'fix', titleKey: 'whatsNew.entries.kanbanTransformNewBoard' },
    ],
  },
  {
    version: '1.10.4',
    date: '2026-08-23',
    entries: [
      { type: 'fix', titleKey: 'whatsNew.entries.kanbanFieldLimits' },
      { type: 'fix', titleKey: 'whatsNew.entries.syncValidationSurfacing' },
    ],
  },
  {
    version: '1.10.3',
    date: '2026-06-18',
    entries: [
      { type: 'fix', titleKey: 'whatsNew.entries.kanbanContextDelete' },
      { type: 'fix', titleKey: 'whatsNew.entries.kanbanSyncReliability' },
    ],
  },
  {
    version: '1.10.2',
  ...
  },
  {
    ...
    date: '2026-06-11',
    entries: [
      { type: 'fix', titleKey: 'whatsNew.entries.syncRetryKick' },
      { type: 'fix', titleKey: 'whatsNew.entries.sharedSaveToast' },
    ],
  },
  {
    version: '1.10.0',
